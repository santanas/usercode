...
batchManager.parser_.add_option("-b", "--batch", dest="batch",
                                help="batch command. default is: bsub -q 1nw80  < batchScript.sh",
                                default="bsub -q 1nw80 < batchScript.sh")
