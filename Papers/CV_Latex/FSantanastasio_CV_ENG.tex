...
In fall 2008, towards the end of my PhD studies in Rome, 
I decided to try a learning experience abroad to continue the research 
...
Since then I have been based at the CERN laboratory, working in the CMS experiment primarily on
\begin{itemize} 
\item data analysis within the exotic physics group (Exotica), looking for evidence 
of new physics beyond the standard model of fundamental interactions; 
\item commissioning, {\it ``prompt analysis''} and detector performance studies 
of the hadronic calorimeter (HCAL);
\item commissioning of missing transverse energy (MET) with first collision data at LHC. 
\end{itemize}
%
...
my involvement in the Exotica group (by starting new physics analysis efforts) and, recently, began 
to coordinate a working team of the CMS experiment devoted to the definition, maintaining, and monitoring of the data streams to be used for physics analysis and detector calibration during 2012 data taking.

\begin{center} \textsc{Research activities related to physics analysis of pp collision data} \\ \end{center} 

Since the beginning of my post-doctoral appointment, I have been actively involved in the research activities of the CMS Exotica group, which is devoted to search for exotic physics beyond the Standard Model. I presented the results of these analyses in international conferences on behalf of the CMS collaboration [see ``Talks at Conferences'']. \\
...
{\bf ``Search for Dijet Resonances in the Dijet Mass Spectrum in pp Collisions at sqrt(s)=7 TeV'}
  ...
  data collected in 2011. I am the main developer of the alternative trigger, data acquisition, and analysis strategy employed in this search to recover sensitivity to new physics at dijet masses below 1 TeV. This analysis is currently under approval process within the CMS Collaboration, and it is aiming for a preliminary public result (CMS Physics Analysis Summary) followed by a publication in the first months of 2012. 
