...
% PhD
\years{Nov 2004 - Jan 2008}\textbf{PhD in Physics}\\ %{\small (highest honours)}\\
...
% Laurea
\years{Sept 1998 - May 2004}\textbf{\textit{Laurea} in Physics} {\small (highest honours)}\\
...
Conference proceedings will be published in date e journal still to be defined\\  [1em] 
%DIS2010
...
Presentation in plenary session on behalf of the HCAL e Jet/MET groups of the CMS experiment\\ [1em] 
%CMS Italia 2010
...
%CRAFT2009
\years{Sept 2009}\textbf{Commissioning and Run Coordination meeting} - CRAFT (Cosmic Run At Four Tesla) 
...
% HCAL PFG 
\years{Sep 2008 - Sep 2010}Coordination of the {\it``Prompt Feedback Group``} of the hadronic calorimeter 
...
$\rightarrow$  presentations on behalf of the HCAL group]. 
...
% MET
\years{Nov 2009 - today}Commissioning of the missing transverse energy (MET) 
reconstructed in the event with the first proton-proton ({\it pp}) collisions at $\sqrt{s}=$0.9, 2.36 and 7 TeV collected by the CMS experiment \cite{JME-10-004,JME-10-002,AN-2010-219,AN-2010-029}. Development and implementation of algorithms for the identification 
...
\years{Jul 2006 - Sep 2006}Monitoring of the high voltage system of the CMS electromagnetic calorimeter (ECAL)
...
My interest for elementary particle physics drove me to choose this field when I was an undergraduate student in Rome 
and, more recently, to do research in the Compact Muon Solenoid (CMS) experiment at the Large Hadron Collider (LHC) 
