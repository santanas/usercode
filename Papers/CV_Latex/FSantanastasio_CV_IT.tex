...
\renewcommand\refname{Referenze \\ \normalsize \begin{center}\textbf{\quad \quad Pubblicazioni relative alle attivit\`a di ricerca}\end{center} }
...
ricostruita nell'evento utilizzando i primi dati di collisioni protone-protone a  0.9, 2.36 e 7 TeV dell'esperimento 
...
nelle prime collisioni a  0.9, 2.36 e 7 TeV \cite{DN-2010-008}. \\ [1em]
% TEST BEAM HCAL 2009
...
del detector CMS \cite{Adzic:2008zza,DN-2007-013,IN-2006-050}.  \\[1em]
%%
\clearpage
%%
%LAUREA
