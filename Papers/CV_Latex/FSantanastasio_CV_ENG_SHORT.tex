...
\textit{University of Maryland}, College Park, MD, US\\[1em]
...
\hrule
\vspace{10pt}
\years{08/2013}\textbf{Vincitore del Programma Per Giovani
...
\emph{Three-year grant for research in experimental high-energy
  physics with the CMS detector at the CERN LHC}
...
Frontiers in Physics, Kolymbari, Crete, \textit{``Searches for BSM
  physics in ﬁnal states with jets and leptons+jets at CMS''}~\cite{Santanastasio:ICNFP2016} \\ [1em]
%ICHEP2014
...
I'm author of 31 internal notes and 7 conference reports of the CMS experiment.
...
Rome, Italy\\ \textit{"Search for heavy resonances in the dijet final state and jet energy calibration"}~\cite{pippo,AN-16-344} \\ [1em]
...
collisions at $\sqrt{s}=13$~TeV~\cite{pippo,Khachatryan:2015dcf}, 
...
and 13 TeV~\cite{Khachatryan:2015dcf,AN-15-063,AN-15-175} with the CMS
...
at~$\sqrt{s}=13$~TeV~\cite{pippo,AN-16-202}. 
