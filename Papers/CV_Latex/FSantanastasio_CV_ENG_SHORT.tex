...
operated at LHC. \\[1em] 
\years{2014 - 2017}\textbf{Member of the i-MCP collaboration} \\
...
\years{01/2018 - today}\textbf{Associate Professor in Physics} \\
\textit{Sapienza Universit\`a di Roma}, Rome, Italy\\[1em]
%Assistant Professor Sapienza
\years{03/2014 - 12/2017}\textbf{Assistant Professor in Physics (RTDb)} \\
\textit{Sapienza Universit\`a di Roma}, Rome, Italy\\[1em]
%CERN Fellow
...
% MORIOND24
\years{24-31/03/2024}\textbf{Moriond/EW 2024} - Rencontres de Moriond on 
``EW Interactions and Unified Theories'', La Thuile, Italy,\textit{``Exotica Searches at CMS''}~\cite{MoriondEW2024} \\  [1em] 
%SCINT19
\years{29/09/2019 - 04/10/2019}\textbf{SCINT2019} - 15th Conference on
Scintillating Materials and their Applications, Sendai, Japan
\textit{``Precision Timing in the CMS MTD Barrel Timing Layer with Crystal Bars and SiPMs''}~\cite{Santanastasio:SCINT2019} \\ [1em]
%GGI2017
\years{09-13/10/2017}\textbf{GGI2017} - Collider Physics and the Cosmos, Galileo Galilei Institute, Arcetri (FI), Italia \textit{``Recent results and future perspectives on searches for dark matter mediators''} \\ [1em]
%ICNFP2016
\years{06-14/07/2016}\textbf{ICNFP2016} - International Conference on New
Frontiers in Physics, Kolymbari, Crete, \textit{``Search for new physics beyond the Standard Model in final states with jets and leptons+jets at CMS''}~\cite{Santanastasio:ICNFP2016} \\ [1em]
%ICHEP2014
...
\vspace{10pt}
\noindent
\years{02/2019 - today}Referee of {\it European Physical Journal C}~\href{https://www.springer.com/journal/10052}{link to
  online journal}~(2023 impact factor = 4.2) \\  [1em]
\years{06/2016 - today}Referee of {\it New Journal of
  Physics}~\href{http://iopscience.iop.org/journal/1367-2630}{link to
  online journal}~(2023 impact factor = 2.8) \\  [1em] 
\years{2011 - today}Chair or member of the internal {\it``Analysis Review
  Committees''} for the scrutiny of public results of the CMS
collaboration (a selection: ~\cite{Sirunyan:2019pnb,Chatrchyan:2012rva,Chatrchyan:2013ual,CMS:2016pkl,Khachatryan:2015bma})
...
I'm author of more than 45 internal notes and 9 conference reports of
the CMS experiment, and 9 articles on detector studies in small collaborations.
...
\hrule
\vspace{10pt}
\years{09/2024 - today}\textbf{Corso di Termodinamica e Laboratorio, Sapienza, Corso di Laurea in Fisica} \\
\emph{Professor of thermodynamics (with related laboratory activities) for physics majors at first year of University}\\[1em]
\years{03/2020 - today}\textbf{Corso di Laboratorio di Meccanica, Sapienza, Corso di Laurea in Fisica} \\
\emph{Professor of laboratory of mechanics (including lessons of
  probability and statistics) for physics majors at first year of University}\\[1em]
\years{03/2015 - 03/2020}\textbf{Corso di Fisica I, Sapienza, Corso di Laurea in Chimica Industriale} \\
\emph{Professor of mechanics and thermodynamics for chemistry
  majors}\\[1em]
\years{03/2018 - 03/2019}\textbf{Corso di Statistica, Sapienza, Corso di Laurea in Chimica} \\
\emph{Professor of error analysis and statistics for chemistry majors}\\[1em]
\years{03/2017 - 08/2018}\textbf{Corso di Physics Laboratory II, Sapienza, Corso di Laurea in Fisica} \\
\emph{Teaching assistant of particle physics laboratory at physics majors}\\[1em]
...
\hrule
\vspace{10pt}
\years{10/2021 - today}\textbf{``Componente del collegio docenti
  del dottorato in fisica degli acceleratori'' at Sapienza} \\
\emph{Member of the judging commitee for the admission to the XXXVIII
  cycle of the Research Doctorate. Contribution to the evaluation of doctoral students.}\\[1em]
\years{09/2019 - 2024}\textbf{``Presidente della Commissione
  per i Prodotti della Ricerca del Dipartimento di Fisica'' at
  Sapienza} \\
\emph{Organization of the activities related to research quality
  evaluation (VQR)}\\[1em]
\years{10/2014 - 04/2018}\textbf{``Referente di Con.Scienze per la Facolt\`a
  di SMFN'' at Sapienza} \\
...
\years{09/2015 - 03/2020}\textbf{Member of ``Commissione Didattica del
...
\years{2024-2027}{\bf Petra Akrap (PhD)}, Current activities on the CMS Mip Timing
Detector. The thesis project will be defined by the end of 2024.
\\ [1em]
\years{2021-2024}{\bf Mattia Campana (PhD)}, \textit{``Search for leptoquarks coupling to muons in lepton-quark collisions at LHC''},
\href{https://www.roma1.infn.it/exp/cms/tesiPHD/index.html}{the thesis
  will be available at this link} \cite{AN-23-093} \\ [1em]  
\years{2022-2023}{\bf Agnese Foglietti (undergraduate)},
\textit{``Search for Leptoquarks in lepton-quark collisions with the CMS experiment at LHC''}
\href{https://www.roma1.infn.it/exp/cms/tesi/tesi_laurea_completate/foglietti.pdf}{link
thesis} \\ [1em]
\years{2022-2023}{\bf Petra Akrap (undergraduate, Erasmus+ program)}, \textit{``Study on the search for leptoquarks in
lepton-quark collisions at the LHC using proton tagged events''}
\href{https://www.roma1.infn.it/exp/cms/tesi/tesi_laurea_completate/akrap.pdf}{link
thesis} \\ [1em]
\years{2019-2022}{\bf Claudio Quaranta (PhD)}, \textit{``Search for
  high-mass resonances in final states with a boosted-dijet resonance
  in proton-proton collisions at $\sqrt{s}=13$~TeV with the CMS
  detector''},
\href{https://www.roma1.infn.it/exp/cms/tesiPHD/tesi_phd_completate/quaranta.pdf}{link
thesis} \cite{CMS:2022tqn,AN-19-273} \\ [1em]  
\years{2018-2019}{\bf Samuele Torelli (undergraduate)}, \textit{``Study of
time resolution and characterization of LYSO crystals for the CMS
MTD''}
\href{https://www.roma1.infn.it/exp/cms/tesi/tesi_laurea_completate/torelli.pdf}{link
thesis} \\ [1em]
\years{2016-2017}{\bf Alfonso Tanga (undergraduate)},\textit{``Ricerca
  di nuove risonanze in stati finali con tre jet a LHC''}
\href{https://www.roma1.infn.it/exp/cms/tesi/tesi_laurea_completate/tanga.pdf}{link
  thesis} \\ [1em]  
\years{2015-2017}{\bf Simone Gelli (PhD)},\textit{``Search for new
  particles decaying into Z$\gamma$/W$\gamma$ final states in proton-proton
  collisions at $\sqrt{s}=13$~TeV''}
\href{https://www.roma1.infn.it/exp/cms/tesiPHD/tesi_phd_completate/gelli.pdf}{link
thesis} 
\\ [1em]  
...
\href{https://www.roma1.infn.it/exp/cms/tesiPHD/tesi_phd_completate/dimperio.pdf}{link
thesis} \cite{Khachatryan:2015dcf}\\
...
\hrule
\vspace{10pt}
%%% Scouting and parking
\years{01/2023 - 07/2024}\textbf{Coordination of the \emph{CMS team for the
  preparation of the Data Scouting and Data Parking review paper}} \\
This analysis group was formed to write a long review paper (about 100
pages) on the topic of ``data scouting and data parking'' in CMS (more
details below and in the highlights section). I led a group constituted by
more than 15 physicists working in universities and research
institutions from all the world. The review paper was submitted for publication in 2024~\cite{CMS:2024zhe}. \\ [1em]
%%% Jets+X
\years{09/2016 - 09/2018}\textbf{Coordination of the \emph{CMS Exotica
...
almost 20 physics analyses in this final state. During my convenership, the group
produced 9 publications (including
~\cite{Sirunyan:2018xlo,Sirunyan:2017nvi,Sirunyan:2018jdk,Sirunyan:2018pom}) 
and 3 preliminary results. The results of the remaining searches are 
...
% Leptoquarks
\years{01/2021 - today}Proponent and author of novel searches for
Leptoquarks (LQs). Due to quantum fluctuations,
protons also contain charged leptons, making it possible to study
lepton-induced processes in pp collisions the LHC. By picking a lepton
from one proton beam and a quark from the other beam, it becomes possible to study the resonant single LQ production and the
...
%The CMS detector is undergoing an extensive Phase II upgrade program 
%to prepare for the challenging conditions of the High-Luminosity 
%LHC (HL-LHC). In particular, a new timing layer will measure 
%minimum ionizing particles (MIPs) with a time resolution of ~30-50
%ps. The precision time information from this detector will reduce the 
%effects of the high pile-up expected at the HL-LHC. It will also
%provide novel identification capabilities for low energy charged 
%particles and will open new possibilities in the search for long-lived 
%particles predicted by theories beyond the standard model. 
...
final production phase in 2024~\cite{DP-24-049}. A comparative
...
%\cite{DN-24-049}
\bibitem{DP-24-049}
  [CMS Collaboration],  ``Barrel Timing Layer Performance Plots''\\
  CMS DN-24-049 (2024), \href{https://cds.cern.ch/record/2904362}{link to pdf}
...
\bibitem{Santanastasio:SCINT2019} 
