...
and search for Supersymmetry in the all-hadronic and the like-sign dilepton channel.}
...
sufficient to bring a signicant fraction of the produced particles 
...
the LHC machine (e.g. interfill period).
...
\begin{figure}[htbp] 
\centering
\includegraphics[width=0.4\textwidth]{DiJetRatio100pbOptFix.eps}\includegraphics[width=0.4\textwidth]{HSCP1.eps}  
...
Nevertheless, the sensitivity of the analyses for 100~pb$^{-1}$ and 1~fb$^{-1}$ at $7$~TeV 
is presented in Figure~\ref{fig:SUSY} using a scan over mSUGRA parameters 
(for both all-hadronic and like-sign diplepton signatures) 
since it allows direct comparison with existing results from Tevatron and LEP experiments.

\begin{figure}[htbp] 
\centering
%\includegraphics[width=0.4\textwidth]{SUSY_allHadronic.eps}\includegraphics[width=0.4\textwidth]{SUSY_likeSignDilepton.eps}  
