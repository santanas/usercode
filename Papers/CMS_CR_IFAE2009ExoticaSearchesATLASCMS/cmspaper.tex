...
with mass of 1 TeV/$c^2$ in the di-muon channel is expected 
to be approximately a factor of 5 worse then the di-electron channel, 
...
Despite that these particles arrive late in the muon system, 
ATLAS and CMS has a good trigger efficiency~\footnote{See details 
...
the calorimeter triggers (such as missing tranverse energy, 
