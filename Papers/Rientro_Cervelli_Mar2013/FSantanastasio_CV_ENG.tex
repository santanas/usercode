...
% WW/WZ/ZZ RESONANCES
\years{Dec 2011 - today} Search for heavy WW / ZZ / WZ / qW / qZ resonances in fully hadronic~\cite{Chatrchyan:2012yxa,AN-11-524} and semi-leptonic $\ell\nu jj$ / $\ell\ell jj$ [analyses in progress] 
...
Invited talk to present a review on this topic, including results from ATLAS and CMS Collaborations\\  [1em]
%PIC2012
...
The analysis is performed in fully hadronic~\cite{Chatrchyan:2012yxa,AN-11-524} and semi-leptonic $\ell\nu jj$ / $\ell\ell jj$ [analyses in progress] final states, and it focuses on resonances which are sufficiently 
...
All the analyses are aiming to a publication in 2013, possibly combining the results from the different channels 
for a few benchmark models of new resonances.\\
