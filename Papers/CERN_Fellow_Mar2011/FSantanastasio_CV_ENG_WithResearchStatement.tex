...
In conclusion, the PFG provided an active contribution to both the HCAL commissioning in 2008-2009, 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Statement of Research Interests and Future Plans}

% pp collision at LHC 
My current research interests are focused on high energy physics
in {\it pp} collisions at the Large Hadron Collider (LHC). 
In particular, I am interested in the physics program of the 
\textbf{Compact Muon Solenoid (CMS) experiment}, in which I have worked since the beginning 
of my graduate studies in 2004. In the next months, I would like to focus 
on searches for physics beyond the standard model, as well as to participate 
in development and performance studies of advanced algorithms for 
jets and missing transverse energy reconstruction, because of their inherent interest
and for their importance in the physics analyses aforementioned.
The detailed scope of this research will continue to be shaped in the course 
of the data taking and analysis of the current run.
In a longer-term future, I am planning to explore other possible analyses
(as Higgs searches), including those for which the research group that I may 
join has expertise and interest. \\

% Physics beyond the standard model and Leptoquarks
My primary research interests embrace the 
\textbf{search for new physics beyond the standard model}.  I presented 
results of searches for exotic physics in the CMS experiment 
at international conferences on behalf of the CMS collaboration [see ``Talks at Conferences'']. 
During my graduate studies,
I worked on a feasibility study of a search for Supersymmetry 
with Gauge-Mediated Breaking (GMSB), in the final state with 
two high $p_T$ prompt photons and large missing transverse energy (MET) 
\cite{Santanastasio:DOTTORATO}. Since the beginning of my post-doctoral 
appointment in 2008, I have been working in the exotic physics group
of the CMS experiment, first on a feasibility study \cite{EXO-08-010}, 
and then on data analysis of  {\it pp} collisions at $\sqrt{s}=7$ TeV for a \textbf{search of leptoquarks (LQs)} 
in the decay channels {\it eejj} \cite{Khachatryan:2010mp} and {\it e$\nu$jj} \cite{AN-2010-361}. 
Although low mass scale LQs, accessible at current colliders, are generally not considered to be 
one of the preferred extensions of the standard model, searches for LQ pair production can be regarded 
as a prime example for new signatures with leptons, jets and MET with a standard 
model background dominated by weak boson and top-pair production, and therefore
represent important benchmark analyses to compare the sensitivity to new physics in general
with other experiments. In parallel with the main research activities that I am going to describe, 
I am planning to continue the LQ searches also in 2011 by supervising an undergraduate 
student devoted to data analysis. I am already in contact with research groups in institutions/universities that belong 
to the CMS Collaboration with the purpose of realizing this project. \\

% Supersymmetry
As of today, one of the most important hints of new physics beyond the standard model 
comes from several cosmological and astrophysical measurements which lead to the 
conclusion that around 25\% of the energy density of the Universe is represented by neutral 
and weakly interacting matter, the so called Dark Matter (DM). 
Unlike the standard model, \textbf{Supersymmetry (SUSY) theory models} 
have a natural DM candidate. 
I am considering the possibility to contribute to the extensive SUSY search program 
of the CMS experiment, focusing 
first on final states similar to those that I have studied for the LQ {\it e$\nu$jj}  analysis. 
In most of considered scenarios, the main experimental signature of production of heavy 
SUSY particles at colliders is represented by the presence of large MET in the event, 
produced by undetected, stable DM particles, in association with leptons, photons and jets. 
Given my past commissioning work in the MET group of CMS with 
early {\it pp} collisions \cite{JME-10-002,AN-2010-029}, I have developed a good understanding 
of the performances of the different MET reconstruction algorithms employed in CMS. 
I also worked on the classification of non-gaussian tails in MET distribution 
\cite{AN-2010-219}, which represent an important background for 
SUSY searches, and their reduction, by developing algorithms to identify anomalous, 
beam-induced noise in the Hadron Forward calorimeter of the CMS experiment \cite{DN-2010-008}. \\

%Particle-Flow
Recently, I am gaining interest in improving my understanding of an advanced event 
reconstruction algorithm used in the CMS experiment.
The \textbf{particle-flow event reconstruction} aims at reconstructing and identifying all (quasi-)stable 
particles in the event, i.e., electrons, muons, photons, charged hadrons and neutral hadrons, with 
a thorough combination of all CMS sub-detectors towards an optimal determination of their 
direction, energy and type. This list of individual particles is then used to build jets, 
to determine MET, to reconstruct and identify taus from their decay products, 
to quantify charged lepton isolation with respect to other particles, etc. 
The design of CMS detector is almost ideally suited to attempt particle-fow
event reconstruction at LHC. The meticulous reconstruction of the full 
particle content of the event has been validated using collision data in 2010, 
showing an improved performance for jets, taus and MET reconstruction, 
with a direct impact on many physics analyses. Given my past experiences 
in the commissioning and calibration of the electromagnetic calorimeter
\cite{Bartoloni:2007hx,Adzic:2008zza,DN-2007-013,IN-2006-050} 
and the hadronic calorimeter [see ``Talks in Plenary Meetings of the CMS Collaboration''] 
of CMS, a natural starting point would be to focus on the side of particle-flow related to 
calorimetry, only to cover later the tracker-related aspects, with the goal of 
achieving a deep understanding of the entire algorithm and being even able to 
make development towards performance improvement. For instance, 
an experimental challenge to handle this year consists in improving algorithms 
for physics object reconstruction to mitigate the effects of overlap of 
energy deposits and tracks from different events due to multiple, simultaneous collisions at LHC (pileup). 
The latter is expected to become significant starting from the 2011 physics run at high luminosity
of the accelerator.

% Supersymmetry

% MET 
    % non-gaussian tails of MET

% Higgs

% Particle Flow
    % start from calorimeter and go to tracker, muon, ...
     % knowledge of HCAL already present
