...
$\sum E_\text{T}$ to Eq.~\ref{eq:MET_sigma} for data and  Monte Carlo at $2360$ GeV. The offset term $D$ was fixed to zero as
 in Section~\ref{sc:DataVsMCMB900}.
...
\begin{figure}[h!]
 ...
 \end{tabular}
 \caption{\small $\sigma\left(\exmiss\right)$ and $\eymiss$ $\sigma$ vs. $\sum E_\text{T}$ for
...
\begin{figure}[h!]
 ...
 \end{tabular}
 \caption{\small Fit of the $\sigma\left(\exmiss\right)$ vs. $\sum E_\text{T}$ for data and Monte Carlo at $2360$ GeV. Parameter $D$ in the fit was fixed
...
\begin{figure}[h!]
 ...
 \end{tabular}
 \caption{\small Fit of the $\sigma\left(\eymiss\right)$ vs. $\sum E_\text{T}$ for data and Monte Carlo at $2360$ GeV. Parameter $D$ in the fit was fixed
          to zero.\label{fig:MEySigma_vs_SumET_2360_fit}}
\end{figure}
