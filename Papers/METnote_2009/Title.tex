...
%  \cmspas{2005/000}
  ...
  \title{Commissioning of Uncorrected Calorimeter Missing Tranverse Energy in Zero Bias and Mininum Bias Events at
         $\boldsymbol{\sqrt{s}=900}$~GeV and $\boldsymbol{\sqrt{s}=2360}$~GeV}
  ...
  \begin{Authlist}
   ...
   \Instfoot{eth}{ETH, Zurich, Switzerland}
    M.~Pierini, M.~Spiropulu\Aref{a}
   \Instfoot{cern}{CERN, European Organization for Nuclear Research, Geneva, Switzerland}
