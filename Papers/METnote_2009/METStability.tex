...
the mean $\sum E_\text{T}$ in Fig.~\ref{fig:SumET_vs_run}. A combined effect of
a missing half of the negative side of HE and an integritiy problem in ECAL EB
result in the mean of $\sum E_\text{T}$ and $\etmiss$ deviating from the trend in
