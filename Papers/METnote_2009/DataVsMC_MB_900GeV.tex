\section{Data to Monte Carlo comparisons at $\boldsymbol{\sqrt{s}=900}$ GeV in
  Minimum Bias events}
...
\begin{figure}[h!]
  ...
  \caption{Lego plot of the highest $\etmiss=40.77$~GeV event (Run 124024, ls 52, event 19351796). It appears
...
\begin{figure}[h!]
  ...
  \caption{The $\etmiss=18.56$~GeV event (Run 124030, ls
