...
\item Run 124030, ls 8, event 2665873: $\etmiss=19.6766$~GeV, an
  ...
  energy lost down the beam pipe.
...
\item Run 124030, ls 14, event 4893420: $\etmiss=18.5625$~GeV, there are
  4 jets in the event, which are back-to-back and one is undermeasured.
...
\item Run 124024, ls 21,  event 7735977: $\etmiss=15.8119$~GeV, two neihboring towers in HB, same $\eta$. No energy deposits in ECAL at the same location, maybe HB noise.

\item Run 124022, ls 130, event 29704007: $\etmiss=15.2424$~GeV,a tower in HB with $E_T\sim 8$~GeV with a few neihbors, no ECAL deposit.
\end{itemize}
