...
The complete \emph{curriculum vitae} is available at\\ 
...
\hrule
\vspace{10pt}
\years{01/2018-today}\textbf{Associate Professor} \\
\emph{Department of Physics, Sapienza Universit\`a di Roma, Rome, Italy}\\ [1em]
\years{03/2014-12/2017}\textbf{Assistant Professor (Ricercatore Tempo Determinato di Tipo B)} \\
\emph{Department of Physics, Sapienza Universit\`a di Roma, Rome, Italy}%\\ [1em]
%\emph{Assistant Professor (Ricercatore Tempo Determinato di Tipo B)}
%from 01/03/2014 to 31/12/2017 \\
...
\hrule
\vspace{10pt}
\years{AA 16-17}\textbf{Fisica I, Sapienza, Corso di Laurea in Chimica Industriale (84 hours, 9 CFU)} \\
...
\emph{Co-tutor for experiment on NaI crystal calorimeter (``Sfera'')}\\ [1em]
\years{AA 15-16}\textbf{Fisica I, Sapienza, Corso di Laurea in Chimica Industriale (84 hours, 9 CFU)} \\
\emph{Mechanics and Thermodynamics}\\ [1em]
\years{AA 14-15}\textbf{Fisica I, Sapienza, Corso di Laurea in Chimica Industriale (84 hours, 9 CFU)} \\
...
\years{2014 - today}\textbf{Member of "Commissione di Laurea in Fisica'' (10
  times)} \\[1em] 
\years{2015 - today}\textbf{``Controrelatore'' of master thesis for
  "Laurea Triennale in Fisica" (4 times)} \\[1em] 
\years{2017 - today}\textbf{``Controrelatore'' of master thesis for
  "Laurea Magistrale in Fisica" (1 time)} 
...
\years{2015-2017} S. Gelli,\textit{``Search for new particles decaying into
  $Z \gamma / W\gamma$ final states in proton-proton collisions at $\sqrt{s}=13$~TeV''}, 
Thesis defense in February 2018 \\ [1em]  
...
\subsection*{Undergraduate (Laurea Magistrale)}
\years{2016-2017}A. Tanga,\textit{``Ricerca di nuove risonanze in
  stati finali con tre jet a LHC''}, [\href{http://www.roma1.infn.it/cms/tesi/tanga.pdf}{thesis}]
...
\vspace{10pt}
%GGI2017
\years{10/2017}\textbf{GGI2017} - Collider Physics and the Cosmos
International Conference, Galileo Galilei Institute, Arcetri, Italy, \textit{``Recent results and
 future perspectives on searches for dark matter mediators''}, Slides~\cite{Santanastasio:GGI2017} \\ [1em]
%ICHEP2014
...
\years{06/2016 - today}Referee of {\it New Journal of
  ...
  online journal}~(2016 impact factor = 3.786) \\  [2em] 
