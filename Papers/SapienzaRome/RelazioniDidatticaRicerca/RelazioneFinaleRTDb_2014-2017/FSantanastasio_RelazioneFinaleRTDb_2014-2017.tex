...
\emph{Curriculum vitae} available at\\ 
...
Results of student assessment of the Fisica 1 courses (questionario ``Opis'') for AA15-16 and AA14-15 are attached to this document.
...
\years{2015 - today}\textbf{``Controrelatore'' of master thesis for
  "Laurea Triennale in Fisica" (2 times)}  \\[1em]
...
\years{2016-2017}A. Tanga,\textit{``Ricerca di risonanze adroniche in
  stati finali con tre jet ad LHC''}, Thesis ongoing \\[1em]
...
\emph{Settore 02/A1 - Fisica Sperimentale delle Interazioni
  Fondamentali} \\[0.5em]
Indicatori: numero di articoli = 495 (51), numero di citazioni =
  19981 (1250), indice H = 63 (18). Le soglie degli indicatori per il
  settore 02/A1 sono riportate in parentesi. La domanda di
  partecipazione ed i giudizi della commissione sono allegati a questo documento.
