...
\hrule
\vspace{10pt}
\years{2016}\textbf{84 publications:} see
...
Total number of publications: 506 (ISI), 530 (inspire) \\
h-index: 56 (ISI) 
...
\hrule
\vspace{10pt}
\years{AA 14-16}\textbf{Corso di Fisica I, Sapienza, Corso di Laurea in Chimica Industriale (9 CFU)} \\
...
constituted by about 20 physicists from several institutions from
...
\years{2015-2017}{\bf Simone Gelli},\textit{``Search for new particles decaying into diboson final states in
  proton-proton collisions at $\sqrt{s}=13$~TeV''}, Thesis ongoing \\ [1em]  
\years{2014-2015} {\bf Giulia D'Imperio}, \textit{``Search for narrow resonances
  in dijet final states at the LHC with $\sqrt{s}=13$~TeV''
} \href{http://www.roma1.infn.it/cms/tesiPHD/dimperio.pdf}{link to
  thesis} ~\cite{Khachatryan:2015dcf},\\[1em]
