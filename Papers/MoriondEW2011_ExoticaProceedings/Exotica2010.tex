...
\subsection{Dilepton and Diphoton Resonances}
...
%      \resizebox{7.9cm}{!}{\includegraphics[angle=0]{beta_vs_m_excl_comb.pdf}} &
%      \resizebox{7.9cm}{!}{\includegraphics[angle=0]{beta_vs_m_excl_comb.pdf}} \\
    \end{tabular}
...
generation scalar LQs has been performed in the \eejj~\cite{PhysRevLett.106.201802}, 
\enujj~\cite{PAPERenujj}, and \mumujj~\cite{PhysRevLett.106.201803} channels. 
The dominant backgrounds for this searches arise from the SM production of 
\zjets, \wjets and \ttbar events.
The reconstructed variable \ST, defined 
below~\footnote{In the \eejj and \mumujj channels, 
\ST is defined as the scalar sum of the transverse momenta of the two 
leading (in \pt) charged leptons and jets. In the \enujj channel, \ST is defined 
as the scalar sum of the transverse momentum of the electron, 
the missing transverse energy (\etmiss), and the two leading jets.} has a large 
signal-to-background discrimination power, and it is used to select LQ candidate events.
...
\bibitem{PAPERenujj}The CMS Collaboration, {\em arXiv:XXXXXX} (2011). Submitted for publication in \PLB.
