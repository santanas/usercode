...
%\vskip 2.5cm
  \begin{center}
    ...
    \caption{(Left) Upper limits as a function of resonance mass, on 
      ...
      individual electron+neutrino and muon+neutrino channels, 
...
via the direct production of a new massive particle that then decays into a dijets final state
...
and same-sign dileptons final states~\cite{Chatrchyan:2011em}, arising from the decay 
...
bosons in the dimuon decay channel arising from the decays of new heavy particles.
The search is optimized for the detection of excited quark 
