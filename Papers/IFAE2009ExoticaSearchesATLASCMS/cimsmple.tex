...
%##The dominant irreducible SM background 
...
%##\includegraphics[width=0.4\textwidth]{Mejfig5R.eps}  
\caption{%#Left: 
...
%##, while in presence of contact interactions, a deviation in the di-jet ratio 
%##at high di-jet mass values is expected.
...
%##If $LQ$s are produced at LHC, such striking signature will not be missed.
}
...
%##%##For example, 
%##The experimentally observed symmetry between 
...
%}
\bibitem{Aad:2009wy}
 \BY{ATLAS Collaboration, Aad, G. {\it et al.}}
...
\bibitem{Bayatian:2006zz}
 \BY{CMS Collaboration, Bayatian, G. L. {\it et al.}}
 \TITLE{CMS physics: Technical design report},
 \Year{2006},
 CERN-LHCC-2006-001, 
 \quad
...
\bibitem{Aaltonen:2008vx}
 ...
 \Vol{100} 
 \Year{2008}
 \Page{091802, and references on the theory therein.}
%%%%%%%%%%%
%%%%%%%%%%%
...
% \Vol{102} 
% \Year{2009}
% \Page{091805, and references on the theory threrein}
...
% \Vol{100} 
% \Year{2008}
% \Page{091802, and references on the theory threrein}
%
%%%%%%%%%%%
%%%%%%%%%%%
%@Article{HEEPNOTE,
...
\bibitem{DIJETSNOTE}
 ...
 \TITLE{CMS Search Plans and Sensitivity to New Physics using Dijets},
 CMS-PAS-SBM-07-001
 \Year{2007}, and references on the theory therein.
...
\bibitem{Fairbairn:2006gg}
 ...
 \Vol{438} 
 \Year{2007}
 \Page{1-63}, and references therein.
%%%%%%%%
%%%%%%%%
%@Article{HSCP,
%     author    = "",
