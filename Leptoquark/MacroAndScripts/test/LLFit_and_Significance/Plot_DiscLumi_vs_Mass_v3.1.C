...
//draw graph
g_SignVSLint->SetMarkerStyle(22);
g_SignVSLint->SetMarkerColor(kGreen);
g_SignVSLint->SetMarkerSize(1);
g_SignVSLint->Draw("psame");
...
TF1 f_sqrtLint ("f_sqrtLint","[0]*sqrt(x)", 0, max_Lint) ;
f_sqrtLint->SetParameter(0,1.);
f_sqrtLint->SetLineColor(kGreen);
g_SignVSLint->Fit("f_sqrtLint","R");
